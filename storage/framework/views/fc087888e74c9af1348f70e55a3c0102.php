...
<head>
    ...
    <title>Login - <?php echo e(config('app.name')); ?>te</title>
    <!-- BEGIN: CSS Assets-->
    <link rel="stylesheet" href="<?php echo e(url('/')); ?>/dist/css/app.css" />
    <!-- END: CSS Assets-->
</head>
<!-- END: Head -->
<body class="login">
    ...
    <div class="block xl:grid grid-cols-2 gap-4">
        ...
        <div class="hidden xl:flex flex-col min-h-screen">
            <a href="" class="-intro-x flex items-center pt-5">
                ...
                <span class="text-white text-lg ml-3"> <?php echo e(config('app.name')); ?> </span>
            </a>
            <div class="my-auto">
                <img alt="<?php echo e(config('app.name')); ?>" class="-intro-x w-1/2 -mt-16" src="<?php echo e(url('/')); ?>/dist/images/illustration.svg">
                <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">
                    A few more clicks to
                    <br>
                    sign in to your account.
                </div>
                <div class="-intro-x mt-5 text-lg text-white">Manage all your business listings in one place</div>
            </div>
        </div>
        <!-- END: Login Info -->
        <!-- BEGIN: Login Form -->
...
<script src="<?php echo e(url('/')); ?>/dist/js/main.js"></script>
<!-- END: JS Assets-->
</body>
</html>
<?php /**PATH C:\Users\hacki\OneDrive\Desktop\Business Directory\Admin\resources\views/pages/admin-auth/admin_login.blade.php ENDPATH**/ ?>