                    ...
                    <div class="flex flex-wrap sm:flex-nowrap items-center mb-2 p-2">
                        ...
                        <ul class="w-full">
                            ...
                            <li>
                                ...
                                <button class="inline-flex items-center mr-1 text-gray-500 border border-purple-500 transition duration-300 hover:bg-purple-500 hover:text-white hover:border-purple-700">
