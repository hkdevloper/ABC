                ...
                <div class="company-info-container">
                    ...
                    <div class="company-info">
                        <div class="heading-line">
                            ...
                            <a class="company-info-rnr" href="#" target="_blank">
                        ...
                        <div class="chips-container p-2">
                            @forelse($company->seo->meta_keywords as $tag)
                                <span class="chip px-2 py-1 card typ-14Medium">#{{$tag}}</span>
                            @empty
                                <span class="chip px-2 py-1 card typ-14Medium">#No Tags</span>
                            @endforelse
                        </div>
                    ...
                    <div class="tab-list-wrapper  ">
                        <div class="tab-list ">
                            <div class="tab-wrapper">
                                <div data-tab="Overview" class="tab-list-item tab-list-active">
