    ...
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 mt-8">
                ...
                <form action="{{route('edit.blog', [$blog->id])}}" method="post" enctype="multipart/form-data"
                    ...
                    <div style="display: flex">
                        ...
                        <div>
                            ...
                            <br>
                            <input type="checkbox" {{$blog->is_featured ? "checked" : ""}}  value="on"
                    ...
                    <div class="mt-3">
                        ...
                        <select name="user" required class="select2 input w-full border mt-2">
                            ...
                            @foreach($users as $user)
                                <option
                                    value="{{$user->id}}" {{$blog->user_id == $user->id ? "selected" : ""}}>{{$user->first_name}} {{$user->last_name}}
                                    [Id: {{$user->id}}]
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mt-3">
                        ...
                        <input id="name" type="text" class="input w-full border mt-2"
                               value="{{old('title') ? old('title') : $blog->title}}" required
                    ...
                    <div class="mt-3">
                        ...
                        <input name="slug" type="text" class="input w-full border mt-2 flex-1" required
                               placeholder="AAA>>bb>>c" id="slug" value="{{old('slug') ? old('slug') : $blog->slug}}">
                    </div>
                    <div class="mt-3">
                        <label>Article Content</label>
                        <textarea id="editor" class="input w-full border mt-2" name="contents"
                                  rows="50">{{old('contents')?old('contents'): $blog->content}}</textarea>
                    </div>
                    <div class="mt-3">
                    ...
                    <input name="media" id="media" type="hidden" value="{{$blog->thumbnail_id }}"/>
                    <div class="mt-3">
                    ...
                    <div class="mt-3">
                        ...
                        <input name="meta_keywords" type="text" class="input w-full border mt-2 flex-1" required
                               ...
                               value="{{old('meta_keywords') ? old('mera_keyword') : $seo->meta_keywords}}">
                    </div>
                    <div class="mt-3">
