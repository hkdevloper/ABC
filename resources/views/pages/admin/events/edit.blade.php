                ...
                <form action="{{route('edit.event', [$id])}}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="mt-3">
                        ...
                        <input id="name" type="text" class="input w-full border mt-2" required autofocus
                               autocomplete="off" value="{{old('title') ? old('title') : $event->title}}"
                    ...
                    <div class="mt-3">
                        ...
                        <input name="slug" type="text" class="input w-full border mt-2 flex-1" required
                               placeholder="AAA>>bb>>c" id="slug" value="{{old('slug')  ? old('slug') : $event->slug}}">
                    </div>
                    <div class="mt-3">
                        <label>Description</label>
                        <textarea id="editor" class="input w-full border mt-2" name="description"
                                  placeholder="Enter Description here">{{old('description') ? old('description') : $event->description}}</textarea>
                    </div>
                    <div class="mt-3">
                        <label>Address</label>
                        <input type="text" class="input w-full border mt-2" name="address"
                               value="{{old('address') ? old('address') : $event->address}}"
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" class="input w-full border mt-2" name="zip_code"
                               value="{{old('zip_code') ? old('zip_code') : $event->zip_code}}"
                    ...
                    <div class="mt-3">
                        ...
                        <input name="longitude" type="text" class="input w-full border mt-2 flex-1" required
                               ...
                               value="{{old('longitude') ? old('longitude') : $event->longitude}}">
                    </div>
                    <div class="mt-3">
                        ...
                        <input name="latitude" type="text" class="input w-full border mt-2 flex-1" required
                               readonly
                               placeholder="" id="latitude"
                               value="{{old('latitude') ? old('latitude') : $event->latitude}}">
                    </div>
                    <div class="mt-3">
                        <label>Website</label>
                    ...
                    <input name="old_thumbnail" type="hidden" required value="{{$event->thumbnail}}"/>
                    <div class="mt-3">
                        <label>Event Galley</label>
                        <input type="file" id="media_file_gallery" class="input w-full border mt-2" multiple required
                               name="file">
                    </div>
                    <input name="gallery[]" id="gallery" type="hidden" required value="{{$event->gallery}}"/>
                    <input name="old_gallery[]" type="hidden" value="{{$event->gallery}}"/>
                    <input name="old_seo_id" type="hidden" value="{{$event->seo_id}}"/>
                    <div class="mt-3">
