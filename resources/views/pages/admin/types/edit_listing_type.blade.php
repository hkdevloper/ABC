        ...
        <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 mt-8">
                ...
                <div class="box p-2 mt-5">
                    <form action="{{route('listing.types.edit', [$type->id])}}" method="post" class="intro-y box p-5">
                        @csrf
                        <div class="flex flex-col sm:flex-row items-center">
                            ...
                            <input type="checkbox" name="published" class="input input--switch border"
                                   @if(old('published') || $type->published) checked @endif >
                        </div>
                        <div class="flex flex-col sm:flex-row items-center  m-2">
                            ...
                            <input type="text" class="input w-full border mt-2 flex-1" name="name_singular"
                                   value="{{old('name_singular')}}{{$type->name_singular}}" id="slug" required>
                        </div>
                        <div class="flex flex-col sm:flex-row items-center  m-2">
                            ...
                            <input type="text" class="input w-full border mt-2 flex-1" name="name_plural"
                                   value="{{old('name_plural')}}{{$type->name_plural}}">
                        </div>
                        <div class="flex flex-col sm:flex-row items-center  m-2">
                            ...
                            <input type="text" class="input w-full border mt-2 flex-1" name="slug"
                                   value="{{old('slug')}}{{$type->slug}}" id="slugvalue" required>
                        </div>
                        <div class="flex flex-col sm:flex-row items-center  m-2">
                            ...
                            <div class="d-inline-flex align-items-center">
                                <span class="fa-3x py-2 px-3 border rounded text-secondary"
                                    ...
                                    <i id="iconpicker-preview-icon" class="{{old('icon')}}{{$type->icon}}"></i>
                                </span>
                            </div>
                            <input id="icon" class="form-control" type="hidden" name="icon" value="{{old('icon')}}{{$type->icon}}">
                        ...
                        <div class="flex flex-col sm:flex-row items-center">
                            ...
                            <input type="checkbox" class="input input--switch border" name="review"
                                   @if(old('review') || $type->enable_reviews) checked @endif>
                        </div>
                        <div class="flex flex-col sm:flex-row items-center  m-2">
                        ...
                        <div class="flex flex-col sm:flex-row items-center m-2">
                            ...
                            <select data-hide-search="true" class="select2 w-full" name="parent_type">
                                ...
                                @foreach($types as $type)
                                    @if($type->id == $type->parent_type)
                                    <option selected value="{{$type->id}}">{{$type->name_singular}}</option>
                                    @endif
                        ...
                        <div class="flex flex-col sm:flex-row items-center m-2">
                            ...
                            <select data-hide-search="true" class="select2 w-full" name="rating_category">
                                ...
                                @if(old('rating_category'))
                                    <option value="{{old('rating_category')}}" selected>{{ucwords(str_replace("_", " ", old('rating_category')))}}</option>
                                @endif
                                @foreach($rating_categories as $rating_category)
                                    @if($rating_category->id == $type->rating_category)
                                    <option selected value="{{$rating_category->id}}">{{$rating_category->name}}</option>
                                    @endif
                        ...
                        <div class="flex flex-col sm:flex-row items-center">
                            ...
                            <input type="checkbox" class="input input--switch border" name="approve_new_listing"
                                   @if(old('approve_new_listing') || $type->approve_new_listing) checked @endif>
                        </div>
                        <div class="flex flex-col sm:flex-row items-center">
                            ...
                            <input type="checkbox" class="input input--switch border" name="approve_updates"
                                   @if(old('approve_updates') || $type->approve_edits) checked @endif>
                        </div>
                        <div class="flex flex-col sm:flex-row items-center">
                            ...
                            <input type="checkbox" class="input input--switch border" name="approve_reviews"
                                   @if(old('approve_reviews') || $type->approve_reviews) checked @endif>
                        </div>
                        <div class="flex flex-col sm:flex-row items-center">
                            ...
                            <input type="checkbox" class="input input--switch border" name="approve_review_comments"
                                   @if(old('approve_review_comments') || $type->approve_review_comments) checked @endif>
                        </div>
                        <div class="flex flex-col sm:flex-row items-center">
                            ...
                            <input type="checkbox" class="input input--switch border" name="approve_messages"
                                   @if(old('approve_messages') || $type->approve_messages) checked @endif>
                        </div>
                        <div class="flex flex-col sm:flex-row items-center">
                            ...
                            <input type="checkbox" class="input input--switch border" name="approve_message_replies"
                                   @if(old('approve_message_replies') || $type->approve_message_replies) checked @endif>
                        </div>
