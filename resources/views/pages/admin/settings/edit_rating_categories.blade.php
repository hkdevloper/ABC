        ...
        <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 mt-8">
                ...
                <div class="box p-2 mt-5">
                    <form action="{{route('settings.rating.categories.edit', ['id'=> $category->id])}}" method="post" class="intro-y box p-5"
                          enctype="multipart/form-data">
                        @csrf
                        <div class="flex flex-col sm:flex-row items-center">
                            <label class="w-full sm:w-20 sm:text-right sm:mr-5">Name</label>
                            <input type="text" class="input w-full border mt-2 flex-1" name="name" value="{{$category->name}}">
                        </div>
