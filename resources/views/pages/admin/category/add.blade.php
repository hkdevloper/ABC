        ...
        <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 mt-8">
                ...
                <div class="intro-y datatable-wrapper box p-5 mt-5">
                    <form action="{{route('add.category', ['type' => $type])}}" method="post"
                        ...
                        <div class="mt-3">
                            ...
                            <input type="hidden" name="icon" id="IconInput" class="input w-full border mt-2">
                        </div>
                        <div class="mt-3">
                            <label>Category Image</label>
                            <input type="file" id="media_file" class="input w-full border mt-2" placeholder="Enter Category Image here" name="file">
                        </div>
