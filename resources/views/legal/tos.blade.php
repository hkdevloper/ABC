...
@section('content')
    <x-user.bread-crumb :data="['Home', 'Legal', 'Terms & Conditions']"/>
    <div class="container py-2 mx-auto">
        ...
        <hr class="my-5">
        <p>
            Welcome to HkDevelopers! These terms and conditions outline the rules and regulations for the use of
            HkDevelopers's Website, located at https://hkdevelopers.com.

            By accessing this website we assume you accept these terms and conditions. Do not continue to use
            HkDevelopers if you do not agree to take all of the terms and conditions stated on this page.
            ...
            Cookies
            We employ the use of cookies. By accessing HkDevelopers, you agreed to use cookies in agreement with the
            HkDevelopers's Privacy Policy.
            ...
            License
            Unless otherwise stated, HkDevelopers and/or its licensors own the intellectual property rights for all
            material on HkDevelopers. All intellectual property rights are reserved. You may access this from
            HkDevelopers for your own personal use subjected to restrictions set in these terms and conditions.

            You must not:

            Republish material from HkDevelopers
            Sell, rent or sub-license material from HkDevelopers
            Reproduce, duplicate or copy material from HkDevelopers
            Redistribute content from HkDevelopers
            This Agreement shall begin on the date hereof.

            Parts of this website offer an opportunity for users to post and exchange opinions and information in
            certain areas of the website. HkDevelopers does not filter, edit, publish or review Comments prior to their
            presence on the website. Comments do not reflect the views and opinions of HkDevelopers,its agents and/or
            affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the
            extent permitted by applicable laws, HkDevelopers shall not be liable for the Comments or for any liability,
            ...
            HkDevelopers reserves the right to monitor all Comments and to remove any Comments which can be considered
            ...
            You hereby grant HkDevelopers a non-exclusive license to use, reproduce, edit and authorize others to use,
            ...
            of HkDevelopers; and (d) the link is in the context of general resource information.
            ...
            website, you must inform us by sending an e-mail to HkDevelopers. Please include your name, your
            ...
            No use of HkDevelopers's logo or other artwork will be allowed for linking absent a trademark license
            agreement.
