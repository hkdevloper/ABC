    ...
    <div class="container mx-auto flex px-4 lg:px-12 py-12 md:py-24 items-center justify-center flex-col">
        <div class="text-center lg:w-2/3 w-full">
            ...
            <div class="flex justify-center">
                <button x-on:click="$dispatch('open-modal', { id: 'Requirement' })" class="inline-flex text-white bg-purple-500 border-0 md:py-2 md:px-6 focus:outline-none hover:bg-purple-600 rounded-full p-2 text-sm md:text-lg shadow-md hover:shadow-xl transition duration-300 ease-in-out">
