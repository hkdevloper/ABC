<footer class="bg-slate-100 dark:bg-foreground px-5 lg:px-0">
    <div class="container mx-auto py-20">
        <div class="grid lg:grid-cols-3 md:grid-cols-1 grid-cols-1 lg:gap-0 gap-7">
            <div>
                <div class="text-base font-semibold text-gray-700 dark:text-gray-100 mb-4"> Quick Links</div>
                <ul>
                    <li class="mb-2">
                        <a href="#" class="flex items-center text-gray-500 dark:text-gray-400 font-normal text-sm">
                            <svg class="w-3 h-3 flex-shrink-0 mr-1" width="8" height="9" viewbox="0 0 8 9"
            ...
            <div>
                <div class="text-base opacity-0 font-semibold text-gray-700 dark:text-gray-100 mb-4"> Quick Links
                </div>
                <ul>
                    <li class="mb-2">
                        <a href="#" class="flex items-center text-gray-500 dark:text-gray-400 font-normal text-sm">
            ...
            <div>
                <div class="text-base font-semibold text-gray-700 dark:text-gray-100 mb-4"> Contact Information
                </div>
                <div class="flex mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg"
                         class="w-4 mr-2 flex-shrink-0 text-gray-500 dark:text-gray-400" viewbox="0 0 20 20"
                         fill="currentColor">
                        <path fill-rule="evenodd"
                              d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z"
                              clip-rule="evenodd"></path>
                    </svg>
                    <div class="text-sm text-gray-500 dark:text-gray-400"> 123 Burdin St. Newyork, USA.</div>
                </div>
                <div class="flex mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg"
                         class="w-4 mr-2 flex-shrink-0 text-gray-500 dark:text-gray-400" fill="none"
                         viewbox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
                              d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                    </svg>
                    <div class="text-sm text-gray-500 dark:text-gray-400"> +(123) 014 235 456</div>
                </div>
                <div class="flex mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg"
                         class="w-4 mr-2 flex-shrink-0 text-gray-500 dark:text-gray-400" fill="none"
                    ...
                    <div class="text-sm text-gray-500 dark:text-gray-400"> accommo@info.com</div>
                </div>
                <div class="flex mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg"
                         class="w-4 mr-2 flex-shrink-0 text-gray-500 dark:text-gray-400" fill="none"
                    ...
                    <div class="text-sm text-gray-500 dark:text-gray-400"> info@bisdir.com</div>
                </div>
                <div class="flex mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg"
                         class="w-4 mr-2 flex-shrink-0 text-gray-500 dark:text-gray-400" fill="none"
                    ...
                    <div class="text-sm text-gray-500 dark:text-gray-400"> ui-lib</div>
                </div>
            </div>
        </div>
    </div>
    <div class="text-base py-5 text-center border-t border-gray-200 dark:border-background">
        <div class="container mx-auto flex justify-between items-center flex-wrap">
            <p class="text-gray-700 dark:text-gray-400 text-left font-normal lg:mb-0 mb-4"> Copyright (C) {{config()->get('app.name')}} Powered By <a
                    href="https://www.hkdevs.com" target="_blank" class="text-blue-500 hover:text-blue-600">HkDevelopers</a>
                2022. All rights reserved. </p>
            <div class="flex flex-wrap">
                <a href="#" class="text-gray-400 hover:text-blue-500 mr-3">
                    <svg class="w-[26px] h-[26px]" width="20" height="21" viewbox="0 0 20 21" fill="none"
