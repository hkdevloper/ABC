...
@section('content')
    ...
    <div class="bg-indigo-700 p-4">
        <a href="#" class="flex flex-col items-center md:flex-row items-start justify-between text-white">
            <div class="text-base md:text-lg font-semibold text-center md:text-left md:flex-grow md:items-center">
                Gear up With HKDevelopers this Week from Sep 11-16
            </div>
            <div class="text-white px-4 py-2 rounded-full mt-2 md:mt-0">
    ...
    <section class="bg-white py-4 md:h-[60vh] flex flex-col items-center justify-center">
        <div class="container mx-auto w-full md:w-[90%] text-center">
            ...
            <div class="mt-2 md:mt-4 flex items-center justify-center">
                <div class="relative ml-2">
                    <input list="searchList" class="rounded-full p-2 md:p-4 w-full md:w-[40vw] focus:outline-none card-hovered"
            ...
            <div class="hkdevs-wdgt-section">
                ...
                <section>
                    <div class="bg-white p-4">
                        <div class="grid xs:grid-cols-2 grid-cols-3 gap-4">
                            <!-- Chip 1 -->
                            <div class="w-full px-2 mb-4 card">
                                <a href="{{ route('company') }}"
                                   class="flex items-center justify-center bg-white rounded-lg p-2 sm:p-4 transition duration-300 ease-in-out">
                                    ...
                                    <img src="https://bit.ly/3ZkHndD" alt="arrow-icon" class="w-3 sm:w-4 h-3 sm:h-4 ml-2 xs:hidden">
                                </a>
                            </div>
                            ...
                            <div class="w-full px-2 mb-4 card">
                                <a href="{{ route('products') }}"
                                   class="flex items-center justify-center bg-white rounded-lg p-2 sm:p-4 transition duration-300 ease-in-out">
                                    ...
                                    <img src="https://bit.ly/3ZkHndD" alt="arrow-icon" class="w-3 sm:w-4 h-3 sm:h-4 ml-2">
                                </a>
                            </div>
